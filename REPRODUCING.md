...
| §4.5, Table 2 | Regex vs LLM per construct; micro 0.767 to 0.884; framework 0.774 to 0.935; 98.3% unanimity over 1,215 decisions | `python3 scripts/score_llm_baseline.py` | `outputs/paper/validation/llm_vs_regex.csv` |
| §5.1 | Shares 46.1 / 21.1 / 13.2 / 17.1 / 7.9 on 76 substantive draws | `python3 scripts/analyze_prevalence.py` | `outputs/paper/validation/prevalence_random.csv` |
| §5.1 | Exact McNemar p = .0066 and p < .0001; accommodation-impact p = .29 | same | `outputs/paper/validation/paired_tests.csv` |
| §5.1 | Power 18.3% at n = 76; 80% power at 383 substantive (~756 draws); assurance 0.63 | same | `outputs/paper/validation/prevalence_summary.json` |
...
| §4.5 | Random draw seed 20260720; 729 requested passes, 729 returned | `python3 scripts/draw_random_sample.py`; `docs/LLM_BASELINE.md` | `data/validation/random_sample_index.json` |
...
- `data/validation/llm_labels_3pass.json` — all three Claude Opus 5 passes,
