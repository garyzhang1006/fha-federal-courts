...
PAPER = {
    ...
    "mcnemar.treat_vs_accomm": 0.009560,
    "mcnemar.treat_vs_impact": 0.000005,
    "mcnemar.accomm_vs_impact": 0.210040,
    "power.at_n76": 0.236,
    "power.n_for_80": 295,
    "power.draws_for_80": 583,
    "power.assurance": 0.64,
    "power.discordant": 23,
    "twfe.n": 8,
...
LLM_CLAIMS = {
    ...
    "claim_refusal_rent_sell": (0.680, 0.548, 0.607, -0.060),
    "claim_reasonable_accommodation": (1.000, 0.944, 0.971, 0.088),
    "claim_zoning_exclusionary": (0.833, 1.000, 0.909, 0.109),
    "claims_micro": (0.872, 0.872, 0.872, 0.105),
}
